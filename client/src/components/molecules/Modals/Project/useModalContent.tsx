...
export const useProjectModalContent = (state: ProjectActions['state'], actions: ProjectActions['actions']) => {
  ...
  return useMemo(() => {
    ...
    const contentMap = {
      ...
      UPDATE: {
        ...
        component: (
          <ProjectForm
            ...
            onSubmit={(data) => actions.updateProject({ ...data })}
            onCancel={actions.closeModals}
            isLoading={isAnyProcessing}
          />
        )
      ...
      RESTORE: {
        ...
        component: (
          <ConfirmDialog
            message={t("admin.projects.modals.restore.confirm", "Czy chcesz przywrócić ten projekt do widoku?")}
