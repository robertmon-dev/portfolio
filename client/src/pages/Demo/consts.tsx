...
export const HEADER_TAGS: HeaderProps["tags"] = [
  ...
  },
  {
    ...
    children: "Stable",
    variant: "success",
    icon: React.createElement(ShieldCheck, { size: 12 }),
  },
...
export const DEMO_TIMELINE_DATA: DemoTimelineData[] = [
  {
    ...
    descDefault:
      "Environment configuration, package installation, and Tokyo Night palette setup.",
  ...
  },
  {
    ...
    descDefault:
      "Creating Buttons, Inputs, Checkboxes, and basic Tags with variants.",
  ...
  },
  {
    ...
    descDefault:
      "Combining atoms into complex components like modals, grids, and data lists.",
  ...
  },
  {
    ...
    descDefault:
      "Building an advanced dropdown with search and multi-select capabilities.",
    cardVariant: "flat",
    tagVariant: "default",
