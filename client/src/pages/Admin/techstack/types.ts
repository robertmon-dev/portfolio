...
export type TechStackAction =
  ...
  | { type: typeof TECH_STACK_ACTIONS.SELECT_TECH_STACK; payload: string | null }
...
export function techStackReducer(state: TechStackState, action: TechStackAction): TechStackState {
  switch (action.type) {
