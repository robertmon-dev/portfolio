...
export class UpdateTechStackService extends BaseService implements TechStackUpdating {
  public async execute(input: { id: string; data: Omit<UpdateTechStackInput, 'id'> }): Promise<TechStack> {
    const { id, data } = input;
