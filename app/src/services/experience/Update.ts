...
export class UpdateExperienceService extends BaseService implements ExperienceUpdating {
  public async execute(input: { id: string; data: Omit<UpdateExperienceInput, 'id'> }): Promise<Experience> {
    const { id, data } = input;
