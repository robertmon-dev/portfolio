...
import { GetGithubStatsService } from "../../github/Get";
import { createFakeGithubStats } from "./utils";
import { githubStatsWithDeepRelationsQuery } from "../../github/queries";
...
describe("GetGithubStatsService", async () => {
  ...
  it("Shall properly fetch data and call redis cache", async () => {
    ...
    expect(ctx.mocks.cache.wrap).toHaveBeenCalledWith(
